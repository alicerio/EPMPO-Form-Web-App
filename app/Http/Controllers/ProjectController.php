...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $project->strategy_2 = request('strategy_1') == '----' ? null : request('strategy_1');
        $project->strategy_3 = request('strategy_1') == '----' ? null : request('strategy_1');
        $project->strategy_4 = request('strategy_1') == '----' ? null : request('strategy_1');
        $project->strategy_5 = request('strategy_1') == '----' ? null : request('strategy_1');
        $project->strategy_6 = request('strategy_1') == '----' ? null : request('strategy_1');
