<div id="mapH" style="display:none;">
  <div class="tip">
    <div>
      ...
      <ol>
        <li>Double click on the desired location to place marker. There is no limit to how many markers you draw, however the more markers you draw the longer it will take to calculate.</li>
        ...
        <li>You may press clear to start over, however if you press a calculation button you will have to wait for the result before you can clear.</li>
        </ol>    
