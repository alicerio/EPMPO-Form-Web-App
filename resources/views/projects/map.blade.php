<div id="mapH" style="display:none;">
  <div class="tip">
    <div>
      ...
      <ol>
        <li>Double click on the desired location to place marker. There is no limit to how many markers you draw,
        ...
        <li>You may press clear to start over, however if you press a calculation button you will have to wait for the
  ...
  <div class="row" style="margin-top:1%">
    ...
    <div class="col-4">
      ...
      <table class="table">
        ...
        <input type="hidden" id="point" class="form-control" name="points[]" value="{{$project->points[$index] ?? ''}}"
          readonly>
        @endforeach
        @else
