            ...
            <div class="required_cmp">
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        ...
                        Example: If a project is being considered as exempt for safety due to the project being proposed
                        as a road diet:
                        ...
                        Is this project consistent with MPO documents, project agreements and environmental documents,
                        El Paso MPO Travel Demand Model (TDM)?
                        ...
                        <textarea name="description_strategy_1" class="form-control"
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        ...
                        <br>
                        Instructions: Please provide analysis from corridor study or similar study that will show the
                        project will address congestion.
                        <textarea name="description_strategy_2" class="form-control"
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        ...
                        patterns.
                        Project descriptions typically include a new roadway or bypass, major or minor road widening to
                        add additional through lanes on an existing highway,
                        major roadway reconstruction, adding capacity to a corridor by improving many related
                        intersections.
                        <textarea name="description_strategy_3" class="form-control"
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        4. Are there other congestion mitigation projects (e.g., transportation demand management, land
                        use, public transportation, ITS and operations, pricing, bicycle and pedestrian, and bottleneck
                        relief)
                        ...
                        <h6><a href="http://www.elpasompo.org/scroll_bar_area/mtp/default.htm" target="_blank">Helpful
                                link</a></h6>
                        <textarea name="description_strategy_4" class="form-control"
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        ...
                        <h6><a href="http://www.elpasompo.org/other/congestion_management_process_/default.htm"
                                target="_blank">Helpful link</a></h6>
                        <textarea name="description_strategy_5" class="form-control"
                ...
                <div class="form-row mb-1">
                    <div class="col">
                        ...
                        <textarea name="description_strategy_6" class="form-control"
                ...
                <p> 7. Describe any congestion mitigation alternatives to the proposed improvement that have been
                    ...
                    corridor-level congestion mitigation strategies that will be evaluated to address the problems and
                ...
                <h6><a href="http://www.elpasompo.org/other/congestion_management_process_/default.htm"
                        target="_blank">Helpful link</a></h6>
                <textarea name="description_strategy_7" class="form-control"
                ...
                <p>9. What are the specific congestion reduction impacts of the implemented strategies?
                    <br>
                    Instructions: Based on the results of the congestion mitigation analysis, document the benefits in
                    terms of specific CMP performance measures when possible.
                </p>
