            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('projects.update',$project->id)}}" method="POST">
                        ...
                        <input type="text" class="form-control" name="mpo_id" autocomplete="off" value="{{ $project->mpo_id }}" disabled>
                        <label>
                            CSJ or CN
                        </label>
                        <input type="text" class="form-control" name="csj_cn" autocomplete="off" value="{{ $project->csj_cn }}" disabled>
                        <label>
                            Project Name
                        </label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id = "funding_vehicles">
                                    <div class="form-row mb-1">
                                        <div class="col-sm-2">
                                            <input type="text" name="funding_category_vehicles" class="form-control" value="{{ $project->funding_category_vehicles }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_vehicles_table()" id="federal_vehicles" type="number" name="funding_federal_vehicles" class="form-control" value="{{ $project->funding_federal_vehicles }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_vehicles_table()" id = "local_vehicles" type="number" name="funding_local_vehicles" class="form-control" value="{{ $project->funding_local_vehicles }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_vehicles_table()" id = "local_beyond_vehicles" type="number" name="funding_local_beyond_vehicles" class="form-control" value="{{ $project->funding_local_beyond_vehicles }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input id = "total_vehicles" type="number" name="funding_total_vehicles" class="form-control" value="{{ $project->funding_total_vehicles }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_vehicles_table()" id = "tdc_vehicles" type="number" name="funding_tdc_vehicles" class="form-control" value="{{ $project->funding_tdc_vehicles }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row mb-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id = "funding_bus">
                                    <div class="form-row mb-1">
                                        <div class="col-sm-2">
                                            <input type="text" name="funding_category_bus" class="form-control" value="{{ $project->funding_category_bus }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_bus_table()" id = "federal_bus" type="number" name="funding_federal_bus" class="form-control" value="{{ $project->funding_federal_bus }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_bus_table()" id = "local_bus" type="number" name="funding_local_bus" class="form-control" value="{{ $project->funding_local_bus }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_bus_table()" id = "local_beyond_bus" type="number" name="funding_local_beyond_bus" class="form-control" value="{{ $project->funding_local_beyond_bus }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="number" id="total_bus" name="funding_total_bus" class="form-control" value="{{ $project->funding_total_bus }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_bus_table()" id = "tdc_bus" type="number" name="funding_tdc_bus" class="form-control" value="{{ $project->funding_tdc_bus }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row mb-1">
                            ...
                            <div class="card-body">
                                <div id="funding_operations">
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-sm-3">
                                            <input onchange="funding_operations_table()" id = "federal_operations" type="number" name="funding_federal_operations" class="form-control" value="{{ $project->funding_federal_operations }}" disabled>
                                        </div>
                                        <div class="col-sm-3">
                                            <input onchange="funding_operations_table()" id = "local_operations" type="number" name="funding_local_operations" class="form-control" value="{{ $project->funding_local_operations }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input onchange="funding_operations_table()" id = "local_beyond_operations" type="number" name="funding_local_beyond_operations" class="form-control" value="{{ $project->funding_local_beyond_operations }}" disabled>
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="number" id="total_operations" name="funding_total_operations" class="form-control" value="{{ $project->funding_total_operations }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row mb-1">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" id="federal_operations_total" name="funding_federal_operations_total" class="form-control" value="{{ $project->funding_federal_operations_total }}" disabled>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="number" id="local_operations_total" name="funding_local_operations_total" class="form-control" value="{{ $project->funding_local_operations_total }}" disabled>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="number" id="local_beyond_operations_total" name="funding_local_beyond_operations_total" class="form-control" value="{{ $project->funding_local_beyond_operations_total }}" disabled>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="number" id="total_operations_total" name="funding_total_operations_total" class="form-control" value="{{ $project->funding_total_operations_total }}" disabled>
                                    </div>
                                </div>
                                <a class="btn btn-primary" role="button">Add Funding</a>
                                <a class="btn btn-primary" role="button">Remove Funding</a>
