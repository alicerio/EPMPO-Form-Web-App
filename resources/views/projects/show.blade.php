            ...
            <div class="form-row mb-1 justify-content-center">
                <div class="col">
                    <h3><a href="http://www.elpasompo.org/civicax/filebank/blobdload.aspx?BlobID=23375"
                            target="_blank">National Goals</a></h3>
                    <label>
                ...
                <div class="form-row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row mb-1">
                            ...
                            <div class="col-sm-2">
                                <input type="date" name="consper_end_date_start_date" class="form-control"
                                    autocomplete="off" value="{{ $project->consper_end_date_start_date }}" disabled>
                            </div>
                            <div class="col-sm-2">
                                <input type="date" name="consper_end_date_end_date" class="form-control"
                                    autocomplete="off" value="{{ $project->consper_end_date_end_date }}" disabled>
                            </div>
                            <div class="col-sm-1">
                                <select disabled name="consper_end_date_progress" class="form-control"
                                    autocomplete="off">
                                    <option>----</option>
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="consper_end_date_comments" class="form-control"
                                    autocomplete="off" value="{{ $project->consper_end_date_comments }}" disabled>
                            </div>
                        </div>
                        {{-- PE Performance --}}
                        <div class="form-row">
                        ...
                        <div class="form-row mb-1">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="date" name="date_reviewed" autocomplete="off"
                                    value="{{ $project->date_reviewed }}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div id="Yoe_cost">
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-sm-6">
                                            <input onchange="yoe_table()" id="yoe_cs_2" type="number"
                                                name="construction_amount" class="form-control"
                                                value="{{ $project->construction_amount }}" disabled>
                                        </div>
                                    </div>
                                    {{--CE--}}
                                    <div class="form-row mb-1">
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-sm-6">
                                            <input onchange="yoe_table()" id="yoe_cs_5" type="number"
                                                name="change_order_amount" class="form-control"
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-sm-6">
                                            <input onchange="yoe_table()" type="number" name="PE_amount"
                                                class="form-control" value="{{ $project->change_order_amount }}"
                                                disabled>
                                        </div>
                                    </div>
                                    {{--Indirects--}}
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-sm-6">
                                            <input onchange="yoe_table()" type="number" name="ROW_amount"
                                                class="form-control" value="{{ $project->ROW_amount }}" disabled>
                                        </div>
                                    </div>
                                    {{--Transfer--}}
                                    <div class="form-row mb-1">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="tot_yoe" type="number" name="total_amount"
                                            title="Sumation of all fields." class="form-control"
                                            value="{{ $project->total_amount }}" disabled>
                                    </div>
                                </div>
                ...
                <label>
                    <input type="number" name="yoe_cost" id="yoe_check" autocomplete="off"
                        value="{{ $project->yoe_cost }}" disabled>
                    YOE Cost
                </label><br>
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row mb-1">
                                <table id="projectFundingTablePg1">
                                    <tr id='pfrow' class="pftpg1">
                                        ...
                                        <td><input type="number" name="funding_total" id="pftpg1_tot0"
                        ...
                        <div class="form-row mb-1">
                            ...
                            <div class="col-sm-2">
                                <input type="number" name="funding_federal_result" id="federal_total"
                                    class="form-control" value="{{ $project->funding_federal_result }}" disabled>
                            </div>
                            <div class="col-sm-2">
